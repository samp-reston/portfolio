...
const MySkills: FunctionComponent = () => {
  ...
  return (
    <div className='bg-white 2xl:px-64 xl:px-64 lg:px-32 md:px-16 px-8 pb-16 min-w-full transition-all ease-linear duration-300 py-32 gap-24 items-center flex flex-col'>
