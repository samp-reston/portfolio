...
const Info: FunctionComponent = () => {
  ...
  return (
    <footer className='flex flex-col gap-8 pt-8 md:pt-0 md:pl-8 grow md:w-min'>
      ...
      <p className='text-black-90 text-p hover:text-secondary transition-all duration-200'><a href={`emailto:${email}`}>{email}</a></p>
      <ul className='flex flex-row gap-6 text-socials text-black-90 grow'>
