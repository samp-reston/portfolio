...
const ContactForm: FunctionComponent = () => {
  return (
    <form id="contact" className='flex flex-col gap-4 grow text-p'>
      ...
      <input type="submit" className='border-4 border-secondary bg-black-75 rounded-lg h-12 text-white focus:outline-none p-1 w-1/2 self-end hover:cursor-pointer hover:text-secondary focus:bg-black-5 focus:text-black-100' value='Send'/>
    </form>
  )
}
